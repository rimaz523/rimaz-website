module "api_management_api" {
  ...
  whitelist_localhost_domain_react        = each.value.whitelist_localhost_domain_react
  whitelist_frontend_webapp_domain_react  = each.value.whitelist_frontend_webapp_domain_react
